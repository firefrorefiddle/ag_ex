...
\usepackage[hang, small,labelfont=bf,up,textfont=it,up
,margin=2cm,justification=centering]{caption} % Custom captions under/above
...
\renewcommand\lstlistingname{Code Part}
